...
##########################################################################################
#####Fig 5 Final (12/22/22)  ######################################################
################################

final_c<-ggplot(data = all_townships, 
...
###Save the REAL final, final, final Fig5 - ha  

ggsave(plot = final_c, device = tiff, width = 10, height = 10, dpi = 301, 
       filename = "./code/Vaccine_to_Sage/figures/final/fig5/Fig5_sage_all_final_color1.tiff")
#smaller jpeg version
ggsave(plot = final_c, device = jpeg, width = 10, height = 10, dpi = 301, 
       filename = "./code/Vaccine_to_Sage/figures/final/fig5/Fig5_sage_all_final_color1.jpeg")
